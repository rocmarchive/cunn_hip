  ...
  int padT, int padW, int padH)
{
  ...
  while (totalZ > 0) {
    ...
    stub_hipLaunchKernel(HIP_KERNEL_NAME(cuda_VolumetricMaxUnpooling_updateOutput), dim3(grid), dim3(block), 0, THCState_getCurrentStream(state), 
  ...
  int padT, int padW, int padH)
{
  ...
  while (totalZ > 0) {
    ...
    stub_hipLaunchKernel(HIP_KERNEL_NAME(cuda_VolumetricMaxUnpooling_updateGradInput), dim3(grid), dim3(block), 0, THCState_getCurrentStream(state), 
                                             cudaGradOutput,
                                             cudaIndices,
                                             cudaGradInput,
                                             dT, dH, dW,
