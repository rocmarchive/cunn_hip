              ...
              float* data_col)
{
  ...
  hipLaunchKernelV2(HIP_KERNEL_NAME(im3d2col_kernel), dim3(GET_BLOCKS(num_kernels)), dim3(CUDA_NUM_THREADS), 0, stream, num_kernels, data_im,
                                   height, width, depth,
              ...
              float* data_im)
{
  ...
  hipLaunchKernelV2(HIP_KERNEL_NAME(col2im3d_kernel), dim3(GET_BLOCKS(num_kernels)), dim3(CUDA_NUM_THREADS), 0, stream, num_kernels, data_col,
